...
namespace Goblin.Ui_Base.Repository
{
    ...
    public sealed partial class Ui_Base_DbContext : Elect.Data.EF.Services.DbContext.DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            optionsBuilder.UseSqlServer(connectionString, sqlServerOptionsAction =>
            {
                ...
                sqlServerOptionsAction.MigrationsAssembly(typeof(Ui_Base_DbContext).GetTypeInfo().Assembly.GetName().Name);
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            builder.AddConfigFromAssembly<Ui_Base_DbContext>(typeof(Ui_Base_DbContext).GetTypeInfo().Assembly);
